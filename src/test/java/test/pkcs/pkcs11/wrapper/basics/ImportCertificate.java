...
package test.pkcs.pkcs11.wrapper.basics;

import test.pkcs.pkcs11.wrapper.TestBase;
  ...
  private void main0(Session session) throws PKCS11Exception, CertificateException, NoSuchAlgorithmException {
    ...
    try {
      while (!importedCompleteChain) {
        ...
        String subjectCommonName = test.pkcs.pkcs11.wrapper.util.Util.getCommontName(subjectName);
        String issuerCommonName = test.pkcs.pkcs11.wrapper.util.Util.getCommontName(issuerName);
